...
// STEP 5: Grab the image element to display the generated image
...
function updateBatteryStatus(battery) {
    ...
    // STEP 5: Fetch image based on battery percentage and display it
    const batteryPercentage = Math.round(battery.level * 100);
    const imageURL = `https://robohash.org/${batteryPercentage}.png`; // Generating image URL
    batteryImage.src = imageURL; // Setting image source
}
